...
export function DayNavigation({ plan }: DayNavigationProps) {
  ...
  return (
    <div className="px-3 py-4 border-y border-border/40">
      <h3 className="text-[11px] sm:text-xs font-medium text-muted-foreground/70 uppercase tracking-widest mb-2 px-2">
        Itinerario
      </h3>
          ...
          return (
            ...
            >
              ...
              <div className={cn(
                ...
                <span className="capitalize text-[10px] sm:text-[11px] opacity-70">{dayOfWeek}</span>
              </div>
